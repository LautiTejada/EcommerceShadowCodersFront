...
import { actualizarDetalleOrden, crearDetalleOrden, getDetalleOrdenById, getDetallesOrden, getDetallesOrdenActivos, getDetallesOrdenByOrdenId } from "../http/detalleOrden";
...
export const useDetalleOrdenStore = create<DetalleOrdenState>((set, get) => ({
    ...
    addDetalleOrden: async (detalle) => {
        try {
            await crearDetalleOrden(detalle);
    ...
    updateDetalleOrden: async (id, nuevaCantidad) => {
        try {
            await actualizarDetalleOrden(id, nuevaCantidad);
            await get().fetchDetallesOrden();
        } catch (error) {
